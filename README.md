...
Чат недели:
* [Веб-дизайн и Вёрстка](https://t.me/webdesign_ru) — Чат по веб-дизайну и вёрстке, HTML, CSS, флекс и бутстрапам, шаблонизаторам, препроцессорам, методологиям и всему сопутствующему. Обсуждаем темы юзабилити, устраиваем А/В тесты лендингов, и проводим аудит.
