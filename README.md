...
* [Personal junior](https://t.me/vadim_junior) — Должность тимлида подразумевает не только ответственность за качество продукта и работу команды, но и помощь начинающим разработчикам. Хотите ощутить на себе эту ношу? Тогда этот канал для вас. "Джун с работы" - ваш персональный джуниор. Код за вас, конечно, не напишет, но глупые вопросы позадает (все как в реальной жизни).
