...
* [CODE SALAD](https://t.me/code_salad) — Канал-блог с записками разработчика, посвящённый как внутренностям Android, операционным системам, embedded-разработке, так и сторонним темам (алгоритмы, FP и т.д.).
